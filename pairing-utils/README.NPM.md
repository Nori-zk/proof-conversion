...
**Verification Key**
- All SP1 v6.0.0 Groth16 proofs use the **same verification key**. This VK is
  embedded in the library (`GROTH16_VK_6_0_0_BYTES`) and loaded automatically.
...
- `vk`: o1js-formatted SP1 v6.0.0 verification key with:
  - `alpha`, `beta`, `gamma`, `delta`: Curve points
  - `alpha_beta`: Precomputed pairing as 12-element Fq12 field
  - `w27`: 27th root of unity as 12-element Fq12 field
...
- **SP1**: Groth16 proofs from SP1 v6.0.0 zkVM
