...
// SP1 v6.1.0 Groth16 VK embedded
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Load arkworks VK for SP1 v6.1.0
    let ark_vk = load_ark_groth16_verifying_key_from_bytes(GROTH16_VK_6_1_0_BYTES)?;
    ...
    println!("🔧 Using SP1 v6.1.0 verification key");
