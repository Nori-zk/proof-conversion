...
async function prove_zkp0() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp0.json`, JSON.stringify(proof0.proof), 'utf8');
...
async function prove_zkp1() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp1.json`, JSON.stringify(proof1.proof), 'utf8');
...
async function prove_zkp2() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp2.json`, JSON.stringify(proof2.proof), 'utf8');
...
async function prove_zkp3() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp3.json`, JSON.stringify(proof3.proof), 'utf8');
...
async function prove_zkp4() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp4.json`, JSON.stringify(proof4.proof), 'utf8');
...
async function prove_zkp5() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp5.json`, JSON.stringify(proof5.proof), 'utf8');
...
async function prove_zkp6() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp6.json`, JSON.stringify(proof6.proof), 'utf8');
...
async function prove_zkp7() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp7.json`, JSON.stringify(proof7.proof), 'utf8');
...
async function prove_zkp8() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp8.json`, JSON.stringify(proof8.proof), 'utf8');
...
async function prove_zkp9() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp9.json`, JSON.stringify(proof9.proof), 'utf8');
...
async function prove_zkp10() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp10.json`, JSON.stringify(proof10.proof), 'utf8');
...
async function prove_zkp11() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp11.json`, JSON.stringify(proof11.proof), 'utf8');
...
async function prove_zkp12() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp12.json`, JSON.stringify(proof12.proof), 'utf8');
...
async function prove_zkp13() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp13.json`, JSON.stringify(proof13.proof), 'utf8');
...
async function prove_zkp14() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp14.json`, JSON.stringify(proof14.proof), 'utf8');
...
async function prove_zkp15() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp15.json`, JSON.stringify(proof15.proof), 'utf8');
...
async function prove_zkp16() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp16.json`, JSON.stringify(proof16.proof), 'utf8');
...
async function prove_zkp17() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp17.json`, JSON.stringify(proof17.proof), 'utf8');
...
async function prove_zkp18() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp18.json`, JSON.stringify(proof18.proof), 'utf8');
...
async function prove_zkp19() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp19.json`, JSON.stringify(proof19.proof), 'utf8');
...
async function prove_zkp20() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp20.json`, JSON.stringify(proof20.proof), 'utf8');
...
async function prove_zkp21() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp21.json`, JSON.stringify(proof21.proof), 'utf8');
...
async function prove_zkp22() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp22.json`, JSON.stringify(proof22.proof), 'utf8');
...
async function prove_zkp23() {
    ...
    fs.writeFileSync(`${workDir}/proofs/layer0/zkp23.json`, JSON.stringify(proof23.proof), 'utf8');
